      ...
      <section className="px-6 md:px-16 pt-16 pb-24 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-24">
          ...
          >
            ...
            <div>
              <h2 className="text-2xl font-bold text-white mb-1">Anton Wretenberg</h2>
              <p className="text-sm text-white/35 uppercase tracking-widest">Co-founder · Developer</p>
            </div>
          ...
          >
            <div className="w-16 h-16 rounded-2xl bg-white/8 border border-white/10" />
            <div>
              <h2 className="text-2xl font-bold text-white mb-1">Nawid</h2>
              <p className="text-sm text-white/35 uppercase tracking-widest">Co-founder · Designer & Developer</p>
            </div>
            <p className="text-white/55 leading-relaxed">
